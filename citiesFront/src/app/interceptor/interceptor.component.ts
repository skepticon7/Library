...
export class InterceptorComponent implements HttpInterceptor {
    private includedRoutes : string[] = ['/addShelf' , "/payment" , '/addReview' , '/addLibrary' , '/addCity' , '/addBook' ,'/pdfBook' , '/librarian/newCity' , '/librarian/newShelf' ,'/librarian/newBook' , '/librarian/newLibrary'];
